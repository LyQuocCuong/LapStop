...
{
    public sealed class AuthentEmployeeServiceWithOptions : IAuthentService
    {
        private readonly IIdentityRepositoryManager _identityRepositories;

        private readonly IOptions<JwtConfiguration> _optionsDefault;
        private readonly IOptionsSnapshot<JwtConfiguration> _optionsSnapshot;
        private readonly IOptionsMonitor<JwtConfiguration> _optionsMonitor;

        private readonly JwtConfiguration _jwtOptionsDefault;
        private readonly JwtConfiguration _jwtOptionsSnapshot;
        private readonly JwtConfiguration _jwtOptionsMonitor;

        public AuthentEmployeeServiceWithOptions(IDomainRepositories domainRepositories,
                                    IOptions<JwtConfiguration> optionsDefault,
                                    IOptionsSnapshot<JwtConfiguration> optionsSnapshot,
                                    IOptionsMonitor<JwtConfiguration> optionsMonitor)
        {
            ...
            _jwtOptionsDefault = optionsDefault.Value;
            _jwtOptionsSnapshot = optionsSnapshot.Get("JwtSnapShot");
            _jwtOptionsMonitor = optionsMonitor.Get("JwtMonitor");
        ...
        private JwtSecurityToken GenerateTokenOptions(SigningCredentials? signingCredentials, List<Claim> claims)
        {
            var tokenOptions = new JwtSecurityToken(
                issuer: _jwtOptionsDefault.ValidIssuer,
                audience: _jwtOptionsSnapshot.ValidAudience,
