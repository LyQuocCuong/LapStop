        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SalesOrderStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrders_SalesOrderStatus_SalesOrderStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeGalleries_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportedInvoices_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImportedInvoices_InvoiceStatus_InvoiceStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExportedInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExportedInvoices_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExportedInvoices_InvoiceStatus_InvoiceStatusId",
                        column: x => x.InvoiceStatusId,
                        principalTable: "InvoiceStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExportedInvoices_SalesOrders_SalesOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderDetail_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrderDetail_SalesOrders_SalesOrderId",
                        column: x => x.SalesOrderId,
                        principalTable: "SalesOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "ImportedInvoiceDetail",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImportedInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportedInvoiceDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImportedInvoiceDetail_ImportedInvoices_ImportedInvoiceId",
                        column: x => x.ImportedInvoiceId,
                        principalTable: "ImportedInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImportedInvoiceDetail_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "ExportedInvoiceDetail",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExportedInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductBarcode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SellingPrice = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExportedInvoiceDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExportedInvoiceDetail_ExportedInvoices_ExportedInvoiceId",
                        column: x => x.ExportedInvoiceId,
                        principalTable: "ExportedInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExportedInvoiceDetail_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeGalleries_EmployeeId",
                table: "EmployeeGalleries",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExportedInvoiceDetail_ExportedInvoiceId",
                table: "ExportedInvoiceDetail",
                column: "ExportedInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ExportedInvoiceDetail_ProductId",
                table: "ExportedInvoiceDetail",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ExportedInvoices_EmployeeId",
                table: "ExportedInvoices",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ExportedInvoices_InvoiceStatusId",
                table: "ExportedInvoices",
                column: "InvoiceStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_ExportedInvoices_SalesOrderId",
                table: "ExportedInvoices",
                column: "SalesOrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ImportedInvoiceDetail_ImportedInvoiceId",
                table: "ImportedInvoiceDetail",
                column: "ImportedInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportedInvoiceDetail_ProductId",
                table: "ImportedInvoiceDetail",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportedInvoices_EmployeeId",
                table: "ImportedInvoices",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportedInvoices_InvoiceStatusId",
                table: "ImportedInvoices",
                column: "InvoiceStatusId");
