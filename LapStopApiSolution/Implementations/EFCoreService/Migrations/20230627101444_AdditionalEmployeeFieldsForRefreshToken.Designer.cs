...
namespace EFCoreService.Migrations
{
    ...
    [Migration("20230627101444_AdditionalEmployeeFieldsForRefreshToken")]
    partial class AdditionalEmployeeFieldsForRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.CustomerAccount", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("Domains.Entities.EmployeeAccount", b =>
                {
            ...
            modelBuilder.Entity("Domains.Entities.EmployeeGallery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.EmployeeRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.EmployeeStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ExportedInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ExportedInvoiceDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ImportedInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ImportedInvoiceDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.InvoiceStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ProductGallery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.ProductStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.SalesOrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Entities.SalesOrderStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.Identities.IdentEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domains.Identities.IdentRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domains.Entities.Cart", b =>
                {
                    b.HasOne("Domains.Entities.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("Domains.Entities.Cart", "CustomerId")
            ...
            modelBuilder.Entity("Domains.Entities.CartItem", b =>
                {
                    b.HasOne("Domains.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Domains.Entities.CustomerAccount", b =>
                {
                    b.HasOne("Domains.Entities.Customer", "Customer")
                        ...
                        .HasForeignKey("Domains.Entities.CustomerAccount", "CustomerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.Employee", b =>
                {
                    b.HasOne("Domains.Entities.EmployeeRole", "EmployeeRole")
                        .WithMany("Employees")
                        .HasForeignKey("EmployeeRoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domains.Entities.EmployeeStatus", "EmployeeStatus")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Domains.Entities.EmployeeAccount", b =>
                {
                    b.HasOne("Domains.Entities.Employee", "Employee")
                        .WithOne("EmployeeAccount")
                        .HasForeignKey("Domains.Entities.EmployeeAccount", "EmployeeId")
            ...
            modelBuilder.Entity("Domains.Entities.ExportedInvoice", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.InvoiceStatus", "InvoiceStatus")
                        .WithMany("ExportedInvoices")
                        .HasForeignKey("InvoiceStatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domains.Entities.SalesOrder", "SalesOrder")
                        .WithOne("ExportedInvoice")
                        .HasForeignKey("Domains.Entities.ExportedInvoice", "SalesOrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.ExportedInvoiceDetail", b =>
                {
                    b.HasOne("Domains.Entities.ExportedInvoice", "ExportedInvoice")
            ...
            modelBuilder.Entity("Domains.Entities.ImportedInvoiceDetail", b =>
                {
                    b.HasOne("Domains.Entities.ImportedInvoice", "ImportedInvoice")
            ...
            modelBuilder.Entity("Domains.Entities.Product", b =>
                {
                    b.HasOne("Domains.Entities.ProductStatus", "ProductStatus")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Domains.Entities.SalesOrder", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.SalesOrderStatus", "SalesOrderStatus")
                        .WithMany("SalesOrders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Domains.Identities.IdentRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Domains.Identities.IdentEmployee", null)
                        .WithMany()
